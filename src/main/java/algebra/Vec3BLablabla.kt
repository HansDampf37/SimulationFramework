 ...
 * @param z z value
 */
open class Vec3BLablabla(var x: Double, var y: Double, var z: Double) {
     ...
     * @return v + w
     */
    operator fun plus(w: Vec3BLablabla): Vec3BLablabla {
        return Vec3BLablabla(x + w.x, y + w.y, z + w.z)
    }
     ...
     * @return v - w
     */
    operator fun minus(w: Vec3BLablabla): Vec3BLablabla {
        return Vec3BLablabla(x - w.x, y - w.y, z - w.z)
    }
     ...
     * @return v - s
     */
    operator fun plus(s: Number): Vec3BLablabla {
        return Vec3BLablabla(x + s.toFloat(), y + s.toFloat(), z + s.toFloat())
    }
     ...
     * @return v - s
     */
    operator fun minus(s: Number): Vec3BLablabla {
        return Vec3BLablabla(x - s.toFloat(), y - s.toFloat(), z - s.toFloat())
    }
     ...
     */
    operator fun times(scalar: Number): Vec3BLablabla {
        return Vec3BLablabla(x * scalar.toDouble(), y * scalar.toDouble(), z * scalar.toDouble())
    }

    operator fun times(other: Vec3BLablabla) = dotProduct(other)
    operator fun div(scalar: Number) = this * (1.0 / scalar.toDouble())

    operator fun unaryMinus(): Vec3BLablabla = Vec3BLablabla(-x, -y, -z)
     ...
     */
    fun normalize(): Vec3BLablabla {
        if (length == 0.0) throw ArithmeticException("Division by zero")
        return Vec3BLablabla(x / length, y / length, z / length)
    }
     ...
     */
    fun dotProduct(v: Vec3BLablabla): Double {
     ...
     */
    fun hasSharpAngleTo(v: Vec3BLablabla): Boolean {
        val w = projectOnto(v)
     ...
     */
    fun projectOnto(ontoThisOne: Vec3BLablabla): Vec3BLablabla {
        var w = Vec3BLablabla(ontoThisOne.x, ontoThisOne.y, ontoThisOne.z)
        w *= (this * (w) / (w * w))
        return w
    }

    override fun equals(other: Any?): Boolean {
        return if (other is Vec3BLablabla) {
     ...
     */
    fun addInPlace(vec: Vec3BLablabla): Vec3BLablabla {
        x += vec.x
        y += vec.y
        z += vec.z
        return this
    ...
    fun scaleInPlace(scalar: Double): Vec3BLablabla {
        x *= scalar
        y *= scalar
        z *= scalar
        return this
     ...
     */
    fun subInPlace(vec: Vec3BLablabla): Vec3BLablabla {
        x -= vec.x
        y -= vec.y
        z -= vec.z
        return this
    ...
    fun crossProduct(vec: Vec3BLablabla): Vec3BLablabla {
        return Vec3BLablabla(y * vec.z - z * vec.y, z * vec.x - x * vec.z, x * vec.y - y * vec.x)
    }

    operator fun times(x: Int): Vec3BLablabla {
        return times(x.toDouble())
    }

    fun angleWith(vec: Vec3BLablabla): Double {
        return acos(vec * this / (vec.length * this.length))
    }

    fun removeComponentParallelTo(direction: Vec3BLablabla): Vec3BLablabla {
        return this - projectOnto(direction)
    }

    companion object{
        val ones = Vec3BLablabla(1.0, 1.0, 1.0)
        val zero = Vec3BLablabla(0.0,0.0,0.0)
        val random get() = Vec3BLablabla(Math.random(), Math.random(), Math.random())
    }
}