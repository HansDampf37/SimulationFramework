...
class CollisionManager {
    ...
    private fun tripleProduct(a: Vec, b: Vec, c: Vec): Vec {
    ...
    private fun handleSimplex(simplex: MutableList<Vec>, direction: Vec): Boolean {
        when (simplex.size) {
            2 -> {
                val b = simplex[0]
                val a = simplex[1]
    ...
    private fun gjk(c1: Collidable, c2: Collidable): Boolean {
        val simplex: MutableList<Vec> = mutableListOf()
