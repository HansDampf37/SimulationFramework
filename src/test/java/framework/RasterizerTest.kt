...
class RasterizerTest {
    ...
    fun testRasterization() {
        ...
        val c1 = Vec3BLablabla(0, 255, 0)
        val c2 = Vec3BLablabla(255, 0, 255)
        val c3 = Vec3BLablabla(255, 0, 0)
        val c4 = Vec3BLablabla(0, 255, 255)
        val c5 = Vec3BLablabla(255, 255, 0)
        val c6 = Vec3BLablabla(0, 0, 255)
        val v1 = Vertex(position = Vec3BLablabla(-10.0, -10.0, 1.0), color = c1, normal = zero)
        val v2 = Vertex(position = Vec3BLablabla(-10.0, 10.0, 2.0), color = c2, normal = zero)
        val v3 = Vertex(position = Vec3BLablabla(10.0, -10.0, 1.0), color = c3, normal = zero)
        val triangle1 = Triangle(v1, v2, v3)
        val v4 = Vertex(position = Vec3BLablabla(-10.0, 10.0, 1.0), color = c4, normal = zero)
        val v5 = Vertex(position = Vec3BLablabla(-10.0, -10.0, 2.0), color = c5, normal = zero)
        val v6 = Vertex(position = Vec3BLablabla(10.0, 10.0, 1.0), color = c6, normal = zero)
    ...
    fun testGetEntityTriangle() {
        val entity = object : Entity {
            ...
            override var color: Vec3BLablabla? = null
            override var position: Vec3BLablabla = Vec3BLablabla(0.0, 0.0, 0.0)
            override var velocity: Vec3BLablabla = Vec3BLablabla(0.0, 0.0, 0.0)
            override var acceleration: Vec3BLablabla = Vec3BLablabla(0.0, 0.0, 0.0)
            override var status: Status = Status.Movable
        }
        rasterizer.rasterizeTriangle(
            Triangle(
                Vertex(Vec3BLablabla(10.0, 20.0, -3.0), Vec3BLablabla.ones * 255, Vec3BLablabla.zero),
                Vertex(Vec3BLablabla(10.0, -20.0, 7.0), Vec3BLablabla.ones * 255, Vec3BLablabla.zero),
                Vertex(Vec3BLablabla(10.0, -35.0, -20.0), Vec3BLablabla.ones * 255, Vec3BLablabla.zero)
            ),
            entity
        )
    ...
    fun testGetEntitySphere() {
        ...
        rasterizer.rasterizeSphere(
            Circle(
                Vertex(Vec3BLablabla(10.0, 0.0, 0.0), Vec3BLablabla.ones * 255, Vec3BLablabla.zero),
                9.0f
            ),
            entity
        )
    ...
    fun testDepthCircle() {
        rasterizer.rasterizeSphere(
            Circle(
                Vertex(10 * camera.lookingDirection, Vec3BLablabla.ones * 255, Vec3BLablabla.zero),
                9.0f
            ),
            null
        )
